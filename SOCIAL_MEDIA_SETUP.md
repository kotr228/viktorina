...
### Крок 1: Відкрийте компонент футера

Знайдіть файл `src/components/Footer.tsx`.

### Крок 2: Знайдіть розділ з посиланнями

Знайдіть у файлі блок `<div className="social-links">` з посиланнями:

```tsx
<a href="https://t.me/M4A2E3_76_w" target="_blank" rel="noopener noreferrer">
```
...
Замініть `M4A2E3_76_w` на ваш Telegram username або назву каналу.
...
Додайте посилання на ваш Instagram (username).
...
Можна додати Facebook, Twitter, TikTok та інші за подібним шаблоном усередині `<div className="social-links">` (стилі вже задані в `src/app/globals.css`):
...
1. Запустіть сайт локально: `npm run dev` і відкрийте http://localhost:3000
